...
function loadUsersTable() {
  ...
  tableBody.innerHTML = paginatedUsers.length ? "" : "<tr><td colspan='3'>No users available</td></tr>";
  ...
  paginatedUsers.forEach(user => {
    ...
    row.innerHTML = `
      ...
      <td>
        <button class="action-btn edit-btn" data-username="${user.username}" title="Edit User"><i class="fas fa-edit"></i></button>
        <button class="action-btn delete-btn" data-username="${user.username}" title="Delete User"><i class="fas fa-trash"></i></button>
      </td>
    `;
